...
<ol class="dd-list">
    <c:forEach items="${categories}" var="category">
        <li class="dd-item dd3-item" data-id="${category.id}">
            ...
            <div class="dd3-content"><a href="<c:url value="/category/edit/${category.id}"/>">${category.name}</a>

                <div style="float:right"><a href="<c:url value="/category/remove/${category.id}"/>"><span
                        style="color:red;opacity:0.5" class="glyphicon glyphicon-remove"></span></a></div>
            </div>
